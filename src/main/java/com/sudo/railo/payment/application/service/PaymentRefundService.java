...
public class PaymentRefundService {
    ...
    public void refundPayment(Long paymentId, String reason) {
        ...
        try {
            // PG사 환불 처리
            PgPaymentCancelRequest refundRequest = PgPaymentCancelRequest.builder()
                    .pgTransactionId(payment.getPgTransactionId())
                    .merchantOrderId(payment.getExternalOrderId())
            ...
            PgPaymentCancelResponse refundResponse = pgPaymentService.cancelPayment(payment.getPaymentMethod(), refundRequest);
            ...
            payment.refund(refundAmount, refundFee, reason, 
                          refundResponse.getPgTransactionId(), 
                          refundResponse.getCancelApprovalNumber());
