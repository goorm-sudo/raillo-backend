...
public class PaymentHistoryController {
    ...
    public ResponseEntity<PaymentHistoryResponse> getPaymentHistory(
        ...
        log.info("회원 결제 내역 조회 요청 - 회원ID: {}, 기간: {} ~ {}", memberId, startDate, endDate);
    ...
    public ResponseEntity<MileageBalanceResponse> getMileageBalance(
        ...
        // TODO: MileageBalanceService 구현 후 연동
        MileageBalanceResponse response = MileageBalanceResponse.builder()
                .memberId(memberId)
                .currentBalance(java.math.BigDecimal.valueOf(10000)) // 임시값
                .activeBalance(java.math.BigDecimal.valueOf(9500))   // 임시값
                .build();
